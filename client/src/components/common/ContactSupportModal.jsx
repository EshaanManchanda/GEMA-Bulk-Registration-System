 ...
 * Displays brand contact information with social links
 */
const ContactSupportModal = ({ isOpen, onClose }) => {
  const { data: brand, isLoading } = useBrandInfo();

  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Need Help?" size="md">
      {isLoading ? (
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-600">
            If you need to update your school code or have any questions about your account,
          ...
          <div className="bg-gray-50 rounded-lg p-4 space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900">{brand?.company_name || 'GEMA'}</p>
            ...
            {brand?.address && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{brand.address}</p>
                </div>
              </div>
            )}
            ...
            {brand?.phone && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href={`tel:${brand.phone}`} className="text-gray-900 hover:text-primary-600">
                    {brand.phone}
                  </a>
                </div>
              </div>
            ...
            {brand?.email && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${brand.email}`} className="text-gray-900 hover:text-primary-600">
                    {brand.email}
                  </a>
                </div>
              </div>
            ...
            {brand?.support_hours && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{brand.support_hours}</p>
                </div>
              </div>
            )}
          </div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {brand?.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-3 py-2 bg-pink-100 hover:bg-pink-200 rounded-lg transition-colors"
                >
              ...
              {brand?.youtube && (
                ...
                >
                  ...
                  <span className="text-sm text-red-700">YouTube</span>
                </a>
              )}
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            {brand?.email && (
              <a href={`mailto:${brand.email}`} className="flex-1">
