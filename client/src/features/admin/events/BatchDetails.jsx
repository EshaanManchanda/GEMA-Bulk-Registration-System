            ...
            <div className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                {batch.offline_payment_details.receipt_url ? (
                                                    <div className="relative group cursor-pointer" onClick={() => setShowReceiptModal(true)}>
                                                        <img
                                                            src={getFullUrl(batch.offline_payment_details.receipt_url)}
                                                            alt="Receipt"
                                                        ...
                                                        />
                                                        <div
                                                            className="w-full h-32 bg-gray-100 rounded-lg border border-gray-200 items-center justify-center flex-col gap-2 hidden"
                                                        >
                                                            <Eye className="w-6 h-6 text-gray-400" />
                                                            <span className="text-xs text-gray-500">Click to view receipt</span>
                                                        </div>
                ...
                >
                    <div className="flex flex-col items-center gap-4">
                        <div className="flex justify-center bg-gray-100 rounded-lg p-2 min-h-[200px] w-full">
                            {batch?.offline_payment_details?.receipt_url && (
                                <img
                                    src={getFullUrl(batch.offline_payment_details.receipt_url)}
                        ...
                        <div className="flex gap-3">
                            <Button
                                variant="primary"
                                onClick={() => window.open(getFullUrl(batch?.offline_payment_details?.receipt_url), '_blank')}
                            >
                                Open in New Tab
                            </Button>
